package com.example.jsondeserializationprototype.gsonmodels
 ...
 */
data class GsonSportsDataApiResponse(val date: LocalDate, val dates: List<Day>, val totalGames: Int) {
    ...
    data class Content(
        val link: String,
        val media: Media?,
        val highlights: GsonGameHighlightResponse.Highlights?
    )
